...
public class RemoteService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        Log.d(RemoteService.class.getSimpleName(), "uid " + uid);
        final PackageManager pm = getPackageManager();
        String name = pm.getNameForUid(uid);
        Log.d(RemoteService.class.getSimpleName(), "name " + name);
    ...
    private final IRemoteService.Stub mBinder = new IRemoteService.Stub() {
        public void registerCallback(IRemoteServiceCallback cb) {
            ...
            Log.d(RemoteService.class.getSimpleName(), String.format("Calling pid: %d", pid));
            String processName;
            ...
            for (ActivityManager.RunningAppProcessInfo proc : processes) {
                if (proc.pid == pid) {
                    ...
                    Log.d(RemoteService.class.getSimpleName(),
                            String.format("Found ProcessName of pid(%d): %s", pid, processName));
                }
            }
            // TODO: remove. this is a test.
        }
...
// END_INCLUDE(exposing_a_service)
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification(android.R.drawable.ic_delete, text,
