...
class UserLocation(context: Context) {
   ...
   *
   * @param maxTime Maximum time before the location is outdated. (default 30 minutes)
   * @return The most accurate and / or timely previously detected location within the {@code
   * maxTime} period.
   */
  fun lastBestLocation(maxTime: Long = 30 * 60 * 1000): Observable<Location> {
    ...
    return Observable.just(bestResult)
  }
