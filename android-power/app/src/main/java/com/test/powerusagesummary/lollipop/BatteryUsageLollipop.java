...
*/
package com.test.powerusagesummary.lollipop;
 ...
 */
public class BatteryUsageLollipop implements IBatteryUsage {
...
//                Log.d(TAG, entry.getLabel() + " " + percentOfMax);
                Log.d(TAG, entry.getLabel() + " " + percentOfTotal);
                mUsages.add(new Pair<String, Float>(entry.getLabel(), (float) percentOfTotal));
            }
        }
