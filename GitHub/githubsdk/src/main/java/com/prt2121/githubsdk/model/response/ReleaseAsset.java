...
public class ReleaseAsset implements Parcelable {
  @SuppressWarnings("unused") public static final Creator<ReleaseAsset> CREATOR =
      new Creator<ReleaseAsset>() {
        @Override public ReleaseAsset createFromParcel(Parcel in) {
          return new ReleaseAsset(in);
        }

        @Override public ReleaseAsset[] newArray(int size) {
