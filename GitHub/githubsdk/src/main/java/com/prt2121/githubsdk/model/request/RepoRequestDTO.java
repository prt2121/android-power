...
public class RepoRequestDTO implements Parcelable {
  @SuppressWarnings("unused") public static final Creator<RepoRequestDTO> CREATOR =
      new Creator<RepoRequestDTO>() {
        @Override public RepoRequestDTO createFromParcel(Parcel in) {
          return new RepoRequestDTO(in);
        }

        @Override public RepoRequestDTO[] newArray(int size) {
