...
public class UserPlan implements Parcelable {
  ...
  @SuppressWarnings("unused") public static final Creator<UserPlan> CREATOR =
      new Creator<UserPlan>() {
        @Override public UserPlan createFromParcel(Parcel in) {
          return new UserPlan(in);
        }

        @Override public UserPlan[] newArray(int size) {
